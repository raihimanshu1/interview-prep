...
public class FailFastVsFailSafeIterators {
    ...
    /*
     * QUESTION 13: Difference between fail-fast and fail-safe iterators.
     *
     * SHORT ANSWER
    ...
    public String shortAnswer() {
        return "Fail-fast iterators detect structural modification and throw ConcurrentModificationException; fail-safe or weakly consistent iterators iterate over a snapshot or concurrent structure.";
    }
    ...
    public String commonMistake() {
        return "Do not modify an ArrayList directly while iterating with for-each.";
    }
    ...
    public static void main(String[] args) {
        FailFastVsFailSafeIterators notes = new FailFastVsFailSafeIterators();
