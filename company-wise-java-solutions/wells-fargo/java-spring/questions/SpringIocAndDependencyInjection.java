...
public class SpringIocAndDependencyInjection {

    /*
     * QUESTION 46: Explain Spring IoC and dependency injection.
     *
     * SHORT ANSWER
    ...
    public String shortAnswer() {
        return "Spring IoC means the container creates and wires objects; dependency injection supplies collaborators from the outside instead of classes constructing them directly.";
    }
    ...
    public String commonMistake() {
        return "Do not instantiate Spring-managed dependencies manually inside services.";
    }
    ...
    public static void main(String[] args) {
        SpringIocAndDependencyInjection notes = new SpringIocAndDependencyInjection();
