...
public class ValidateRestPayloads {

    /*
     * QUESTION 52: How do you validate REST request payloads?
     *
     * SHORT ANSWER
    ...
    public String shortAnswer() {
        return "Validate REST payloads with Bean Validation annotations, explicit domain validation, sanitized error responses, and validation at every external boundary.";
    }
    ...
    public String commonMistake() {
        return "Do not trust client-side validation.";
    }
    ...
    public static void main(String[] args) {
        ValidateRestPayloads notes = new ValidateRestPayloads();
