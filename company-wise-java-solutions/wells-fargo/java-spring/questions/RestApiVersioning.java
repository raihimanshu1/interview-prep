...
public class RestApiVersioning {

    /*
     * QUESTION 60: How do you version REST APIs?
     *
     * SHORT ANSWER
     * REST APIs can be versioned through URI paths, headers, or media types; choose a consistent strategy and avoid breaking existing clients silently.
     *
     * IN-DEPTH ANSWER
     * - Use additive changes when possible.
     * - Version only when contract semantics break.
     * - Publish deprecation timelines.
     * - Keep old versions monitored until clients migrate.
     *
     ...
     * // /api/v1/transfers keeps old contract.
     * // /api/v2/transfers introduces a new field meaning or required input.
     * // Additive optional fields usually do not require a new major version.
     *
     * REAL BACKEND / BANKING USE CASE
     * A bank may expose /v1/transfers while introducing /v2/transfers for changed response semantics.
     *
     ...
     * - Do not create a new version for every tiny additive field.
     * - Do not keep old versions forever without monitoring and retirement plans.
     *
     * INTERVIEW TIPS
    ...
    public String shortAnswer() {
        return "REST APIs can be versioned through URI paths, headers, or media types; choose a consistent strategy and avoid breaking existing clients silently.";
    }
    ...
    public String commonMistake() {
        return "Do not break existing clients silently.";
    }
    ...
    public static void main(String[] args) {
        RestApiVersioning notes = new RestApiVersioning();
