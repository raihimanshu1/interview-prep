...
public class StreamOperations {
    ...
    /*
     * QUESTION 22: Difference between map, flatMap, filter, reduce, and collect.
     *
     * SHORT ANSWER
    ...
    public String shortAnswer() {
        return "map transforms each element, flatMap flattens nested streams, filter keeps matching elements, reduce combines values, and collect accumulates into a container/result.";
    }
    ...
    public String commonMistake() {
        return "Do not mutate external state inside stream operations.";
    }
    ...
    public static void main(String[] args) {
        StreamOperations notes = new StreamOperations();
