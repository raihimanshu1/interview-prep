...
def fix_package_in_file(filepath):
    """Fix package declaration properly - remove from comments and place correctly"""
    try:
        ...
        # Remove any existing package declarations (even if in comments)
        new_lines = []
        ...
        for i, line in enumerate(lines):
            ...
            # Remove lines that are package declarations (even inside comments)
