...
package com.lldtop16.vendingMachine;
import java.util.*;
public class VendingMachine {
    ...
    */
    static class IdleState implements VendingMachineState {
        ...
        public void selectProduct(VendingMachine machine, int id) {
    ...
    */
    static class HasMoneyState implements VendingMachineState {
        ...
        public void selectProduct(VendingMachine machine, int productId) {
            Product product = machine.inventory.products.get(productId);
            if (product == null) {
                System.out.println("Product not found");
                return;
            }
            if (!machine.inventory.available(productId)) {
    ...
    */
    static class DispenseState implements VendingMachineState {
        ...
        public void dispense(VendingMachine machine) {
            Product product = machine.inventory.removeProduct(machine.selectedProduct);
            machine.balance -= product.price;
            System.out.println("Dispensed : " + product.name);
            System.out.println("Change returned : " + machine.balance);
            machine.balance = 0;
            machine.selectedProduct = 0;
    ...
    */
    public static void main(String[] args) {
        ...
        machine.inventory.addProduct(new Product(1, "Coke", 50), 5);
        machine.inventory.addProduct(new Product(2, "Chips", 30), 3);
