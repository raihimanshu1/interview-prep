package com.lldtop16.movieticketbooking.simpleapproach;
...
public class MovieTicketBooking {
    ...
    */
    static class Screen {
        ...
        Screen(int screenId, List<Seat> seats) {
    ...
    */
    static class Show {
        ...
        Show(Movie movie, Screen screen, LocalDateTime time) {
            this.movie = movie;
            this.screen = screen;
            this.time = time;
        }
    ...
    */
    static class BookingService {
        public Ticket book(Show show, List<String> seatIds, PricingStrategy pricing, PaymentGateway payment) {
            List<Seat> seats = new ArrayList<>();
            // Find seats
            for (String id : seatIds) {
                Seat seat = show.getScreen().findSeat(id);
            ...
            // Calculate amount
            double amount = pricing.calculate(seats);
            // Payment
    ...
    public static void main(String[] args) {
        ...
        Ticket ticket = service.book(show, List.of("A1", "A2"), new StandardPricing(), new UpiPayment());
