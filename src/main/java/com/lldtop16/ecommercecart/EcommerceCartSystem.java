package com.lldtop16.ecommercecart;
...
public class EcommerceCartSystem {
    ...
    */
    public static void main(String[] args) {
        ...
        Product mouse = new Product(2, "Mouse", 1000);
        User user = new User(1, "John");
        user.cart.addProduct(laptop);
        user.cart.addProduct(laptop);
        user.cart.addProduct(mouse);
        CheckoutService checkout = new CheckoutService();
        checkout.discountStrategy = new PercentageDiscount(10);
        Order order = checkout.checkout(user);
        System.out.println("Order Created : " + order.amount);
    }
}
/*
============================================================
