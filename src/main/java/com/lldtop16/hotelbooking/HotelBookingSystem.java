package com.lldtop16.hotelbooking;
...
public class HotelBookingSystem {
    ...
    */
    static class Booking {
        ...
        Booking(int id, Guest guest, Room room, int checkIn, int checkOut, double amount) {
            this.id = id;
            this.guest = guest;
            this.room = room;
    ...
    */
    interface PricingStrategy {
        double calculate(Room room, int days);
    }
    static class NormalPricing implements PricingStrategy {
        public double calculate(Room room, int days) {
    ...
    */
    static class BookingService {
        ...
        Booking bookRoom(int bookingId, Guest guest, Room room, int checkIn, int checkOut) {
            int days = checkOut - checkIn;
            if (!room.isAvailable(checkIn, checkOut)) {
                throw new RuntimeException("Room unavailable");
            }
            double price = pricingStrategy.calculate(room, days);
            Booking booking = new Booking(bookingId, guest, room, checkIn, checkOut, price);
    ...
    */
    public static void main(String[] args) {
        Hotel hotel = new Hotel(1, "Grand Hotel");
        Room room = new Room(101, RoomType.DOUBLE, 2000);
        hotel.addRoom(room);
        Guest guest = new Guest(1, "John");
        BookingService service = new BookingService();
        Booking booking = service.bookRoom(1, guest, room, 10, 12);
