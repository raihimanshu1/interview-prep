...
public class TransactionalBasics {

    /*
     * QUESTION 54: How does @Transactional work?
     *
     * SHORT ANSWER
    ...
    public String shortAnswer() {
        return "@Transactional wraps a Spring-managed method in a database transaction so work is committed on success and rolled back on configured failures.";
    }
    ...
    public String commonMistake() {
        return "Do not put @Transactional on private methods and expect proxy advice.";
    }
    ...
    public static void main(String[] args) {
        TransactionalBasics notes = new TransactionalBasics();
