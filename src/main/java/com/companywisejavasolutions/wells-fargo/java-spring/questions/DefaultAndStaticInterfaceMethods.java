...
public class DefaultAndStaticInterfaceMethods {
    ...
    /*
     * QUESTION 4: How do default and static methods in interfaces work?
     *
     * SHORT ANSWER
    ...
    public String shortAnswer() {
        return "Default methods are inherited instance behavior in interfaces. Static interface methods are helpers called on the interface name.";
    }
    ...
    public String commonMistake() {
        return "Conflicting default methods from two interfaces must be resolved in the class.";
    }
    ...
    public static void main(String[] args) {
        DefaultAndStaticInterfaceMethods notes = new DefaultAndStaticInterfaceMethods();
