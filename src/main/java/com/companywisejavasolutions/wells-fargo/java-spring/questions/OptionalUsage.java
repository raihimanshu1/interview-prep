...
public class OptionalUsage {
    ...
    /*
     * QUESTION 25: Explain Optional; when is it useful and when is it overused?
     *
     * SHORT ANSWER
    ...
    public String shortAnswer() {
        return "Optional represents an optional return value, mainly to avoid ambiguous null returns; it should not be used for fields, parameters, or serialization-heavy DTOs by default.";
    }
    ...
    public String commonMistake() {
        return "Do not call Optional.get blindly.";
    }
    ...
    public static void main(String[] args) {
        OptionalUsage notes = new OptionalUsage();
