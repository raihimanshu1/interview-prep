...
public class EqualsAndHashCodeContract {
    ...
    /*
     * QUESTION 8: Explain equals() and hashCode() contract.
     *
     * SHORT ANSWER
    ...
    public String shortAnswer() {
        return "Equal objects must return the same hash code. Hash collections use hashCode to find a bucket and equals to confirm the key.";
    }
    ...
    public String commonMistake() {
        return "If equals uses mutable fields, maps and sets can break after mutation.";
    }
    ...
    public static void main(String[] args) {
        EqualsAndHashCodeContract notes = new EqualsAndHashCodeContract();
