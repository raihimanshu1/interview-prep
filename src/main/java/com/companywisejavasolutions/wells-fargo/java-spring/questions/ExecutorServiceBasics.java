...
public class ExecutorServiceBasics {
    ...
    /*
     * QUESTION 37: How does an executor service work?
     *
     * SHORT ANSWER
    ...
    public String shortAnswer() {
        return "ExecutorService separates task submission from thread management and uses a pool plus queue to run work asynchronously.";
    }
    ...
    public String commonMistake() {
        return "Do not create a new executor for every request.";
    }
    ...
    public static void main(String[] args) {
        ExecutorServiceBasics notes = new ExecutorServiceBasics();
